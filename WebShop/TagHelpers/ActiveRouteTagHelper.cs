...
{
    [HtmlTargetElement(Attributes="is-active-rote")]
    public class ActiveRouteTagHelper: TagHelper
    {
        ...
        {
            get => _routeValues ?? (this._routeValues =
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var ignoreAction = context.AllAttributes.TryGetAttribute("ignore-action", out _);
